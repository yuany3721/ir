...
public class main {
    ...
    private Set<String> getWords(String file) {
        // File segment = new
        // File("E:\\website_IR\\src\\main\\java\\com\\ir\\site\\util\\ir\\" + file);
        // File segment = new File("/home/yuany3721/ir/irfiles/words/" + file);
        // File segment = new File("src/main/resources/static/" + file);
    ...
    private void handleTitle(String line) {
        ...
        try {
            ...
            // doc.id + "标题分词.txt");
            File file = new File("/home/yuany3721/ir/irfiles/" + doc.id + "divide.txt");
            if (!file.exists()) {
                file.createNewFile();
            }
    ...
    private void handlePassage(String line) {
        if (isReference) {
            ...
            if (checkTitle.contains("（") || checkTitle.contains("(") || checkTitle.contains("、")
                    || checkTitle.contains(".")) {
    ...
    private void print() {
        try {
            // File file = new
            // File("E:\\website_IR\\src\\main\\java\\com\\ir\\site\\util\\ir\\txt\\toRead\\"
            // + doc.id + ".txt");
            File file = new File("/home/yuany3721/ir/irfiles/toRead/" + doc.id + ".txt");
            if (!file.exists()) {
                file.createNewFile();
            }
            FileWriter fileWriter = new FileWriter(file.getAbsoluteFile());
    ...
    public void newMain(File filename) {
        ...
        // filename.renameTo(new
        // File("E:\\website_IR\\src\\main\\java\\com\\ir\\site\\util\\ir\\txt\\toShow\\"
        // + doc.id + ".txt"));
        filename.renameTo(new File("/home/yuany3721/ir/irfiles/toShow/" + doc.id + ".txt"));
    }
    ...
    public void main() {
        ...
        main func = new main();
        // String filepath =
        // "E:\\website_IR\\src\\main\\java\\com\\ir\\site\\util\\ir\\txt";
        String filepath = "/home/yuany3721/ir/irfiles";

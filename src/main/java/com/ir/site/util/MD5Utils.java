...
public class MD5Utils {
    ...
    public static void main(String[] args) {
        ...
        String strMD5 = new String("167012");
        ...
        System.out.println("saltMD5:" + getSaltMD5(strMD5));
        System.out.println("isThis:" + getSaltverifyMD5(strMD5,getSaltMD5(strMD5)));

        System.out.println("\t\t=======================================");
        // 原文
        String plaintext = "167012";
